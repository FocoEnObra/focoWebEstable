    ...
    Private Sub Ingresar()
        ...
        If vUser IsNot Nothing Then
            ...
            Else
                ...
                ' esta validacion hay que revisar dado que ocurre cuando se seleeciona previamente la empresa
                ' pero dado el caso que ahora el frond end sera distinto al backend ..  debe ser omitido 
