					...
					<div class="tab-content tab-content-bordered panel-padding">
                             ...
                             <div class="panel ">
                                       ...
                                       <%--     <script type="text/javascript">
                                           ...
                                           <dx:ASPxTreeList ClientInstanceName="lista"   SettingsExport-ExpandAllNodes   ="true"  ID="treeUcos" runat="server" AutoGenerateColumns="False" 
                                                  DataSourceID="SqlDataSource1" EnablePagingCallbackAnimation="True" EnableTheming="True" KeyFieldName="ID_UCO" 
                                                  ...
                                                  <Columns>
                                                    ...
                                                    <dx:TreeListTextColumn AutoFilterCondition="Default" FieldName="TIPOUCO" ReadOnly="True" ShowInCustomizationForm="True" ShowInFilterControl="Default" Visible="False" VisibleIndex="10">
                                                       ...
                                                       <dx:TreeListDataColumn FieldName="Location" >
                                                        ...
                                                        <Settings ShowFilterRowMenu="True" ShowGroupFooter="True" ShowHeaderFilterButton="True" ScrollableHeight="300" VerticalScrollBarMode="Auto" EnableFilterControlPopupMenuScrolling="True" GridLines="Both" ShowFilterRow="True" ShowFilterBar="Visible" />
                        ...
                        <div class="panel ">
                                       ...
                                       <div class="panel-body">
                                             ...
                                             <dx:ASPxVerticalGrid  ClientInstanceName ="listavertical"  ID="ASPxVerticalGrid1" runat="server" AutoGenerateRows="False" DataSourceID="sqlRol_vb"   EnableTheming="True" KeyFieldName="ID_PLT_VB" Theme="MaterialCompact" Width="100%">
